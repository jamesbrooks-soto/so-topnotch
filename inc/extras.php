...
// Wrap classes for layout_grid_content
function cellWrapClasses($classes = ''){

  if ($classes) {
    $classesToAdd = '<div class="grid-cell d-flex ' . $classes . '">';
    return $classesToAdd;
  } else {
    $classesToAdd = '<div class="grid-cell d-flex">';
    return $classesToAdd;
  }
}
